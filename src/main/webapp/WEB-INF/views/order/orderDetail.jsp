...
<body>
	...
	<div class="container">
		...
		<div class="delivery-info">
			<h3>배송 정보</h3>
			<ul>
				<li><span class="label">받는 사람:</span><span class="value">${sessionScope.vo.userName }</span></li>
				<li><span class="label">연락처:</span><span class="value">${sessionScope.vo.userPhonenumber }</span></li>
				<li><span class="label">주소:</span><span class="value">${sessionScope.vo.streetAddress }${sessionScope.vo.detailAddress }</span></li>
				<li><span class="label">지하 1층 교보문고</span></li>
			</ul>
		</div>
