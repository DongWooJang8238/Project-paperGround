				...
				<div class="part-sub-wrap">
						<div class="part-sub-row">
							<textarea rows="2" class="part-title-auto"
								...
								style="height: 55px;">${wevo.episodeTitle}</textarea>
							<div class="part-text-component">
								<textarea rows="1" class="p-text-auto"
									placeholder="작품 내용을 입력하세요." name="content"
									style="height: 240px; overflow: hidden;">${wevo.content}</textarea>
							</div>
						</div>
						<div class="part-sub-row">
							<div class="part-review-component">
								...
								<textarea rows="1" class="p-review-auto"
									...
									style="height: 120px; overflow: hidden;">${wevo.episodeComment}</textarea>
							</div>
						</div>
						<input type="hidden" name="wno" value="${wno}">
						<input type="hidden" name="episodeno" value="${wevo.episodeno}">
						<input type="hidden" name="episodeCount" value="${wevo.episodeCount}">
...
<script type="text/javascript" src="/resources/js/write/updateEpisode.js"></script>
